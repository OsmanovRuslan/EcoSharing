...
import org.springframework.http.MediaType; // Для указания типа контента
import org.springframework.security.core.AuthenticationException;
import org.springframework.security.web.AuthenticationEntryPoint; // Интерфейс Spring Security
import org.springframework.stereotype.Component;
import ru.ecosharing.user_service.dto.response.ErrorResponse; // Наш DTO ошибки
